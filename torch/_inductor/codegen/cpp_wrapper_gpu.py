...
class CppWrapperGpu(CppWrapperCpu):
    ...
    def finalize_prefix(self):
        ...
        # Kick off parallel compile for all lazy Triton kernels at module load.
        # Emitting a file-scope struct with a ctor keeps this off the hot path
        # and avoids threading an explicit init call through inductor_entry_impl.
